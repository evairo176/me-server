...
var generateToken = function (id) {
    return jwt.sign({ id: id }, process.env.JWT_KEY, { expiresIn: "20d" });
};
...
var sharpUpload = function (file, title) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, pathUploadFile, pathSave, pathImage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                filename = "".concat(title, "-").concat(Date.now(), ".webp");
                pathUploadFile = "public/images/blogs/";
                pathSave = "images/blogs/";
                pathImage = pathSave + filename;
            ...
            case 1:
                _a.sent();
                return [2 /*return*/, pathImage];
        }
    });
}); };
exports.sharpUpload = sharpUpload;
// Function to delete an existing image file
var deleteImage = function (imagePath) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fs.unlink(imagePath, function (err) {
                    if (err) {
                        throw new Error("Error deleting the image file:", err);
                    }
                    else {
